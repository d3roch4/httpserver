...
void HttpServer::run(const string &addr, std::vector<std::pair<unsigned short, bool>> ports, const string &doc_root, int thread_qtd, const std::string& certificadoFileName, const std::string& chaveFileName, const cors_origin_config& crossOrigin)
{
    router_.set_public_dir(doc_root);
    router_.set_cors_origin(crossOrigin);
